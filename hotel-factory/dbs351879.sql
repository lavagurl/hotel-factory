...
--
-- Hôte : mysql-mvc
-- Généré le : lun. 13 juil. 2020 à 19:17
...
--
-- Déchargement des données de la table `htlfac157896_faq_answer`
--

INSERT INTO `htlfac157896_faq_answer` (`id`, `answer`, `idHfFaqQuestion`, `idHfUser`) VALUES
(1, 'Dans le menu, vous avez accÃ¨s Ã  une page nommÃ©e \"Mon profil\", il vous suffit de cliquer dessus pour accÃ©der Ã  votre profil. ', 1, 52),
(4, 'Vous avez accÃ¨s Ã  une page de permission qui vous permet d\'ajouter diffÃ©rents utilisateurs.', 4, 52),
(5, 'Dans votre page de paramÃ¨tre.', 9, 52);
...
(1, 'Comment faire pour accÃ:copyright:der Ã  mon profil ?', 58, 1),
(2, 'Comment changer l\'adresse de mon hotel ?', 56, 0),
(4, 'Comment ajouter un administrateur Ã  mon site ?', 56, 1),
(8, 'Comment puis-je vous contacter ?', 56, 0),
(9, 'OÃ¹ puis-je trouver les couleurs de mon site ? ', 58, 1);
...
INSERT INTO `htlfac157896_hotel` (`id`, `name`, `address`, `zipcode`, `city`, `country`, `status`, `route`) VALUES
(1, 'Demo Hotel Paris', '4 villa Mï¿½ridienne', '75014', 'Paris', 'France', 1, '/demohotel'),
(2, 'Au petit Paris', '6 rue des popotins', '64587', 'Le Var', 'France', 1, '/aupetitparis'),
(3, 'Soleil des antilles', '5 rue des vacances', '97200', 'Fort de France', 'France', 0, '/soleildesantilles');

-- --------------------------------------------------------

--
-- Structure de la table `htlfac157896_pages`
--

CREATE TABLE `htlfac157896_pages` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `htlfac157896_user` (
  ...
  `idHfRole` int(11) NOT NULL DEFAULT '4',
...
(52, 'quintasmarie@gmail.com', '81ee8dd6ae54f1b8da004f2582ff8361', 'QUINTAS', 'Marie', '1998-02-19', '2020-07-02 21:43:53', 1, NULL, NULL),
(53, 'sarah.oztas96@gmail.com', '552235b7d316b2ffae5d349d52b54c73', 'OZTAS', 'Sarah', '1996-04-04', '2020-07-02 21:46:19', 1, NULL, NULL),
(54, 'elemee@gmail.com', 'ddc7f49bd02999672c1794fff6ec6bdf', 'LEMEE', 'Ewan', '1998-11-21', '2020-07-02 21:48:53', 3, NULL, NULL),
(55, 'jmello@gmail.com', 'dc5c59f6c6fde685900c60d9cc7337a8', 'MELLO', 'Julien', '1988-09-13', '2020-07-02 21:53:17', 3, NULL, NULL),
(56, 'ellendupont@gmail.com', 'aeb9404ad3fcaacb2a00f46de9cd3bef', 'DUPONT', 'Ellen', '1996-12-03', '2020-07-02 22:01:33', 2, NULL, NULL),
(57, 'hstyles@gmail.com', 'd7d91b9bd140737cc1064eb6acade4bf', 'STYLES', 'Harry', '1994-02-01', '2020-07-02 22:06:02', 4, NULL, NULL),
(58, 'e.louis@gmail.com', '1c4521136eb4a635bb881df737ce3c39', 'LOUIS', 'Etienne', '2001-06-15', '2020-07-03 19:54:15', 2, NULL, NULL);
...
--
-- Index pour la table `htlfac157896_pages`
--
ALTER TABLE `htlfac157896_pages`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `htlfac157896_pages`
--
ALTER TABLE `htlfac157896_pages`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
