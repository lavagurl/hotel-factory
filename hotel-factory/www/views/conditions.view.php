...
<div>
    ...
    <h2>L'essentiel</h2>
    <p>
        Nous (le personnel de HotelFactory) avons pour mission de vous aider sur Internet. Nous espérons que vous aimez nos produits et services (outils de publication de sites Web et nouvelles idées que l’avenir nous inspirera) autant que nous aimons les créer.
        <br>
    ...
    <p>
        Ces Conditions régissent votre accès à et votre utilisation de hotel-factory.com ainsi que de l’intégralité du contenu et des produits et services disponibles sur ou via ces sites Web (collectivement, les « Services »).
        <br>
        Ces Conditions régissent également l’accès des visiteurs et leur utilisation des sites Web exploitant nos Services, comme les sites Web hébergés sur hotel-factory.com au profit de nos utilisateurs.
        <br>
    ...
    <h2>1) Définition des parties prenantes</h2>
    <p>
        ...
        <br>
        Nous faisons référence à HotelFactory et hotel-factory.com en tant que « HotelFactory » ou « nous » dans ces Conditions.
    </p>
    ...
    <br>
    <p>
        Nous n’avons pas non plus vérifié et ne sommes pas non plus en mesure de vérifier tous les contenus mis à disposition sur les sites Web et les pages Web vers lesquels hotel-factory.com ou nos autres Services comprennent des liens ou qui comprennent des liens vers hotel-factory.com ou nos autres Services. Par exemple :
    </p>
    <ul>
        <li>
    ...
    <ul>
        ...
        <li>
            ne surchargera pas les systèmes de HotelFactory, tel que nous l’aurons déterminé à notre seule discrétion ;
        </li>
        <li>
