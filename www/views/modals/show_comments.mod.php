                ...
                <tr>
                   ...
                   ?>
                    ...
                    <?php if($key != "id" && $key != "idHfUser" && $key != "active"): ?>
                        <td><input type="text" value="<?= $fields[$key] ?>" name="<?= $key ?>" disabled="disabled"/></td>
                    <?php elseif ($key == "id"): ?>
                        <td hidden="hidden"><input type="number" value="<?= $fields[$key] ?>" name="<?= $key ?>" disabled="disabled"/></td>
                    <?php elseif($key != "active") : ?>
                        <td><input type="text" value="<?= $user->getName().' '.$user->getFirstname() ?>" name="<?= $key ?>" disabled="disabled"/></td>
                    <?php endif;
                    endif;
                    endforeach; ?>
                </tr>
